Doskonale rozumiem, o co chodzi. Poprawiam logikę, aby informacja o zmianie roku liturgicznego pojawiała się tylko wtedy, gdy dane dla poprzedniego okresu są kompletne (nie są `null`). Jeśli poprzedni rok liturgiczny nie jest zdefiniowany, dodatkowy tekst nie będzie wyświetlany.

Poniżej znajduje się zaktualizowany plik z wprowadzoną poprawką.
